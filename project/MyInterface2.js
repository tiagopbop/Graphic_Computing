...
export class MyInterface2 extends CGFinterface {
  ...
  init(application) {
    ...
    this.gui
      .add(this.cameraPan, "leftRight", -200, 200)
      .name("Left/Right Camera Movement")
      .onChange((value) => {
    ...
    this.gui
      .add(this.cameraPan, "upDown", -200, 200)
      .name("Up/Down Camera Movement")
      .onChange((value) => {
    ...
    // Object Selection
    this.gui
      .add(this.scene, "selectedObject", this.scene.objectList)
