...
export class MyScene extends CGFscene {
    ...
    checkKeys(t) {
        ...
        if (this.gui.isKeyPressed("KeyW")) this.heli.accelerate(4 * f);

        if (this.gui.isKeyPressed("KeyS")) this.heli.accelerate(-1.5 * f);

        if (this.gui.isKeyPressed("KeyA")) this.heli.turn(0.02 * f);

        if (this.gui.isKeyPressed("KeyD")) this.heli.turn(-0.02 * f);
