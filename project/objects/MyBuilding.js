...
export class MyBuilding extends CGFobject {
    ...
    display() {
        ...
        // Display the top panel without texture and position it correctly
        this.scene.pushMatrix();
        this.scene.concreteMaterial.apply();
    ...
    displayColumns() {
        ...
        columnPositions.forEach(([x, y, z]) => {
            this.scene.pushMatrix();
            this.scene.concreteTilesMaterial.apply();
    ...
    displayGarage() {
        this.scene.pushMatrix();
        this.scene.sandstoneBrickWallMaterial.apply();
